...
def evaluate(actual_output: Any, expected_output: Dict[str, Any]) -> Dict[str, float]:
    ...
    if "prd" in actual_output:
        ...
        required_sections = expected_output["validation_rules"]["must_have_prd_sections"]
    ...
    if "clarifying_questions" in actual_output:
        ...
        expected_count = expected_output["validation_rules"]["clarifying_questions_count"]
    ...
    if "contradictions" in actual_output and "prd" in actual_output:
        ...
        for contradiction in contradictions:
            ...
            if isinstance(contradiction, dict):
                items = contradiction.get("items", []) or [contradiction.get("req1", ""), contradiction.get("req2", "")]
    ...
    if "contradictions" in actual_output:
        ...
        for contradiction in contradictions:
            if isinstance(contradiction, dict):
                has_items = "items" in contradiction or ("req1" in contradiction and "req2" in contradiction)
